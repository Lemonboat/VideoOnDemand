...
namespace VideoOnDemand.UI.Repositories
{
    public class MockReadRepository : IReadRepository
    {
        ...
        {
                    new UserCourse { UserId = "5480d2d5-e7c8-41c5-a698-59d63c6e93cc",
                        CourseId = 1 },
                    new UserCourse { UserId = "52fea619-b895-479f-8226-954f177886d0",
                        CourseId = 2 },
                    new UserCourse { UserId = "08aa23eb-70de-453a-91e2-8606da019a47",
                        CourseId = 3 },
                    new UserCourse { UserId = "52fea619-b895-479f-8226-954f177886d0",
                        CourseId = 1 },
        };
